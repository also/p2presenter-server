...
public class PhilosopherVisualization extends JComponent implements TableStateListener {
	...
	private void calculateSizes() {
		table = new Ellipse2D.Double(TABLE_ORIGIN, TABLE_ORIGIN, TABLE_DIAMETER, TABLE_DIAMETER);
		
		double plateDiameter = min(TABLE_DIAMETER / 4, TABLE_DIAMETER * 1.5 / philosophers.size());
